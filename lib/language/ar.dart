...
const Map<String, String> ar = {
  ...
  profileEn:profileAr,
  firstSemesterEn:firstSemesterAr,
  secondSemesterEn:secondSemesterAr,
  logoutDialogEn:logoutDialogAr,
  createDescriptionEn:createDescriptionAr,
  briefFeedbackEn:briefFeedbackAr
};
